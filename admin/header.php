...
if(!isset($_SESSION['user_data'])){
   header("location:http://localhost/SeProject/login.php");
}
?>
<!DOCTYPE html>
<html lang="en">
   ...
   <body id="page-top">
      ...
      <ul class="navbar-nav bg-dark sidebar sidebar-dark accordion" id="accordionSidebar">
         ...
         <a class="sidebar-brand d-flex align-items-center justify-content-center" href="blog.php">
            <div class="sidebar-brand-icon rotate-n-15"> <i class="fa fa-smile"></i> </div>
            <div class="sidebar-brand-text mx-3">UKIYO</div>
         </a>
         <!-- Divider -->
