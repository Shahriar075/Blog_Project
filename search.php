...
$offset=($page-1)*$limit;
//-----
$sql="SELECT * FROM blog LEFT JOIN categories ON blog.categories=categories.cat_id
LEFT JOIN user ON blog.author_id=user.user_id WHERE blog_title like '%$keyword%'
or blog_body like '%$keyword%' ORDER BY blog.publish_date DESC limit $offset,$limit";
				...
				<div class="card-body d-flex blog_flex">
					...
					<div class="flex-grow-1 flex-part2">
						...
						<p>
                          ...
                          <?= strip_tags(substr($result['blog_body'],0,400))."..." ?>
						  </a> <span><br>
...
<!--Pagination-->
      <?php
	  $pagination="SELECT * FROM blog WHERE blog_title like '%$keyword%'
      or blog_body like '%$keyword%'";
